...
@media(max-width:920px){
  .hero{height:auto;max-height:none;min-height:0;overflow:visible;padding:34px 0 44px}
  .hero-inner{padding:0 20px}
  .home-services .services-grid{grid-template-columns:1fr 1fr}
}
@media(max-width:768px){
  .hero::after{background:linear-gradient(180deg,rgba(0,0,0,.5) 0%,rgba(0,0,0,.72) 100%)}
...
@media(max-width:600px){
  ...
  .home-services .service-card{min-height:0}
